...
namespace SweetBoxInventorySystem.Models
{
    public class Item : Product
    {
        ...
        public Item(int productId, string productName, int productQuantity, DateTime expiryDate,
            string syrupPumps, string cups, string lidsAndSleeves, string stirrers, string straws, string napkins, string togoBags)
        ...
        {
            return $"Item: {SyrupPumps}, {Cups}, {LidsAndSleeves}, {Stirrers}, {Straws}, {Napkins}, {TogoBags}";
        }
    }
}
